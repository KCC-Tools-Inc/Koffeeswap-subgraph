...
export class KoffeeSwapFactory extends Entity {
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save KoffeeSwapFactory entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save KoffeeSwapFactory entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("KoffeeSwapFactory", id.toString(), this);
  }

  static load(id: string): KoffeeSwapFactory | null {
    return store.get("KoffeeSwapFactory", id) as KoffeeSwapFactory | null;
  }
  ...
  get totalVolumeKCS(): BigDecimal {
    let value = this.get("totalVolumeKCS");
    return value.toBigDecimal();
  }

  set totalVolumeKCS(value: BigDecimal) {
    this.set("totalVolumeKCS", Value.fromBigDecimal(value));
  }
  ...
  get totalLiquidityKCS(): BigDecimal {
    let value = this.get("totalLiquidityKCS");
    return value.toBigDecimal();
  }

  set totalLiquidityKCS(value: BigDecimal) {
    this.set("totalLiquidityKCS", Value.fromBigDecimal(value));
  }
...
export class Token extends Entity {
  ...
  get derivedKCS(): BigDecimal | null {
    let value = this.get("derivedKCS");
    if (value === null) {
      return null;
    } else {
      return value.toBigDecimal();
  ...
  set derivedKCS(value: BigDecimal | null) {
    if (value === null) {
      this.unset("derivedKCS");
    } else {
      this.set("derivedKCS", Value.fromBigDecimal(value as BigDecimal));
    }
  }
...
export class Pair extends Entity {
  ...
  get reserveKCS(): BigDecimal {
    let value = this.get("reserveKCS");
    return value.toBigDecimal();
  }

  set reserveKCS(value: BigDecimal) {
    this.set("reserveKCS", Value.fromBigDecimal(value));
  }
  ...
  get trackedReserveKCS(): BigDecimal {
    let value = this.get("trackedReserveKCS");
    return value.toBigDecimal();
  }

  set trackedReserveKCS(value: BigDecimal) {
    this.set("trackedReserveKCS", Value.fromBigDecimal(value));
  }
  ...
  get swapTxCount(): BigInt {
    let value = this.get("swapTxCount");
    return value.toBigInt();
  }

  set swapTxCount(value: BigInt) {
    this.set("swapTxCount", Value.fromBigInt(value));
  }
  ...
  get burnTxCount(): BigInt {
    let value = this.get("burnTxCount");
    return value.toBigInt();
  }

  set burnTxCount(value: BigInt) {
    this.set("burnTxCount", Value.fromBigInt(value));
  }
...
export class Bundle extends Entity {
  ...
  get kcsPrice(): BigDecimal {
    let value = this.get("kcsPrice");
    return value.toBigDecimal();
  }

  set kcsPrice(value: BigDecimal) {
    this.set("kcsPrice", Value.fromBigDecimal(value));
  }
}

export class KoffeeSwapDayData extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save KoffeeSwapDayData entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save KoffeeSwapDayData entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("KoffeeSwapDayData", id.toString(), this);
  }

  static load(id: string): KoffeeSwapDayData | null {
    return store.get("KoffeeSwapDayData", id) as KoffeeSwapDayData | null;
  }
  ...
  get dailyVolumeKCS(): BigDecimal {
    let value = this.get("dailyVolumeKCS");
    return value.toBigDecimal();
  }

  set dailyVolumeKCS(value: BigDecimal) {
    this.set("dailyVolumeKCS", Value.fromBigDecimal(value));
  }
